      ...
      <div className='wrapper-perbaikan'>
        <div className='perbaikan'>
          ...
          <div className='bottom'>
            <h1 className='list-info'>Ketentuan dapat mengajukan penggantian KTM</h1>
            <ul className="custom-list">
              <li>Terdaftar sebagai mahasiswa yang masih menempuh pendidikan di Telkom University.</li>
              <li>KTM yang dinyatakan hilang.</li>
            </ul>
          ...
          <ul className='lis'>
            ...
            <div className="form-container">
              ...
              {/* <div className='form-row'>
                <label htmlFor='upload-ktm'>Upload KTM :</label>
                <input type='file' placeholder='Choose File' name='upload-ktm'/>
              </div>
              <div className='form-row'>
                <label htmlFor='upload-bukti'>Upload Bukti Pembayaran :</label>
                <input type='file' placeholder='Choose File' name='upload-bukti'/>
              </div> */}
            {/* </div> */}
