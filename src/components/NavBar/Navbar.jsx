            ...
            <nav className="nav container">
                ...
                <div className={`nav__menu ${showMenu ? "show-menu" : ""}`} id="nav-menu">
                    <ul className="nav__list">
                        ...
                        <li className="nav__item">
                            <div className="nav__name-container"> {/* Added a container */}
                                <span className="nav__link">{nama}</span> {/* Display user name */}
                ...
                <div className="nav__toggle" onClick={toggleMenu}>
                    {showMenu ? <IoClose className="nav__close" /> : <IoMenu className="nav__open" />}
                </div>
            </nav>
        </header>
    );
